...
export const socialLinks = [
  { name: 'Instagram', icon: Camera, url: 'https://www.instagram.com/_widyassaaa/?hl=en', color: 'hover:border-blue-500/50 hover:text-blue-500' },
  ...
  { name: 'GitHub', icon: Code, url: 'https://github.com/WidyaSari-pages', color: 'hover:border-blue-500/50 hover:text-blue-500' },
